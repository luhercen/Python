#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""is211 Assignment 7, pig game version 2 """
...
class ComputerPlayer(Player):
	...
	def deciding(self):
		...
		minval = 25
		maxval = 100 - self.score
		if(minval < maxval):
			limit = minval
		else:
			limit = maxval
			
		if(self.turn_score < limit):
			print "Rolling"
			self.hold = False
			self.roll = True			
		else:
...
class Game(object):
    ...
    def __init__(self,player1,player2,die):
        ...
        self.player1.score_per_turn = self.score_per_turn
        self.player1.name = "Player 1"

        self.player2 = player2
        self.player2.score = 0
        self.player2.score_per_turn = self.score_per_turn
